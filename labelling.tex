...
Now construct a perfectly balanced tree $T_0$ with vertex set $V(T_0):=\{s_1,\ldots,s_p\}=Z\cup X$.  The tree $T_0$ has $p+1$ external nodes $a_0,\ldots,a_p$.  We obtain our new subtree $T_x'$ by replacing $a_\ell$ with $A_\ell$ for each $\ell\in\{0,\ldots,p\}$. 
