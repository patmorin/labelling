...
\begin{rem}
  The $o(\log n)$ term in the label length of \thmref{pxp} is $O(k + k^{-1}\lg n)$.  An asymptotically optimal choice of $k$ is therefore $k=\lceil\sqrt{\log n}\rceil$, yielding labels of length $\log n + O(\sqrt{\lg n})$.
\end{rem}
