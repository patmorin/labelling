...
\begin{lem}\lemlabel{bulktree-height-i}
  ...
  \begin{compactenum}[(i)]
    ...
    \item $h(T_{y^*}) = \log|T_{y^*}|+\Oh(k+k^{-1}\log|T_{y^*}|)$.
  \end{compactenum}
\end{lem}
