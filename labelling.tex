...
\begin{figure}
  ...
  \end{center}
  \caption{An illustration of \obsref{predecessor-encoding}: (1)~$\sigma_T(y_1)=11000$ and $\sigma_T(x_1)=1\xcancel{1000}$ (2)~$\sigma_T(y_2)=10\xcancel{011}$ and $\sigma_T(x_2)=10011$.}
