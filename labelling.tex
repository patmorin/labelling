...
Now observe that, for any $y\in\{0,\ldots,y^*\}$,  we have
\begin{align}
y^*
...
\begin{proof}
  ...
  \begin{proof}[Proof of \clmref{deletion-ancestor}]  
    ...
    If $x_T(v)=x_0$ then recall that $v\in S_y\subseteq S^-_y$ and $X_{y+1}\supseteq V(T_{y+1})$ contains both endpoints of each interval in $S^-_{y+1}\cup S^-_y$.  Therefore $a_v,b_v\in V(T_{y+1})$.  Therefore $r\ge 1$ and $x_1\in [a_v,b_v]$ so $x_{\tilde{T}}(v)=x_1$ and $\sigma_{\tilde{T}}(x_{\tilde{T}}(v))=\sigma_T(x_T(v))$.
