...
which is $O\left(\sqrt{\log n\log\log n}\right)$ in our proof. 
...
naturally generalises for other surfaces. A graph $G$ is
...
that already $1$-planar graphs are not minor closed.
...
labelling scheme. 
%Furthermore, for each of these families of graphs
