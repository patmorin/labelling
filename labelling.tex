...
\begin{enumerate}[(PC1)]
  ...
  \item $\varphi'(p_j(v))$ for each $j\in\{1,\ldots,t+1\}$;\snote{L. I assume these $\varphi'$ should be replaced by $\tau$ of \lemref{t-tree-labelling}?}
  \item $\varphi'(v)$;
  \item $\mu_y(v)$;
  \item $a(z)$.
\end{enumerate}
