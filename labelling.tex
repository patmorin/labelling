...
\begin{enumerate}
  ...
  We compute $F(\tau_{T_y}(v_1),\tau_{T_y}(v_2))$ and determine if $v_1$ and $v_2$ are adjacent in $H[S^-_y]$. 
  ...
  In this case (PC2)--(PC5) contains $\tau_{T_y}(v_1)$ and $\tau_{T_y}(v_2)$ (defined in \lemref{t-tree-labelling} using (TC1)--(TC4)) and we use this to test if $v_1v_2\in E(H)$.  If not, then $z_1z_2\not\in E(H\boxtimes P)$ so $z_1z_2\not\in E(G)$.
