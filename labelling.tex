...
Before continuing, we extend the $\sigma$ notation slightly so that for any node $z\in V(T)$ and any $T$-ancestor $x$ of $z$, $\sigma_T(x,z)=\sigma_{T_x}(z)$ where $T_x$ is the subtree of $T$ rooted at $x$.
