...
\begin{proof}
  ...
  First we show (B2) implies (i).  Recall that $y^*=\lceil\log|T_0|/(\log(2^k/7))\rceil$ so
...
The proof of \lemref{chunked-bulk-trees} follows immediately from \lemref{fractional}
